...
namespace GameManager.levels
{
    public class Level1 : GameScreen
    {
        ...
        {           
            ...
            fontSystem.AddFont(TitleContainer.OpenStream(
                $"{Content.RootDirectory}/dogicapixel.ttf")); 
            ...
            tilemapManager = new TilemapManager(map, tileset, tilesetTileWidth, 
                tileWidth, tileHeight, GraphicsDevice, Game._spriteBatch);
            #endregion
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (hasWon)
            {
                Game1.isBlocked = true;

                Debug.WriteLine("[i] Next level!");

                Game.gameColor = new Color(0.2f, 0.2f, 0.2f, 0.9f);
                MenuPanel.Push();

                if (Button.Put("Well done! Next Level", 30, Color.AliceBlue).Clicked)
                {
                    hasWon = false;
                    Game1.isBlocked = false;
            ...
            {                
                ...
                if (Button.Put("Game Over! Try again", 30, Color.AliceBlue).Clicked)
                {
                    Game1.hasDied = false;
                    Game1.isBlocked = false;
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            Game._spriteBatch.Draw(renderTarget, new Vector2(0, 0), null, 
                Game.gameColor, 0f, new Vector2(), 8f, SpriteEffects.None, 0);
            Game._spriteBatch.End();
            _ui.Draw(gameTime);
        }
    }
