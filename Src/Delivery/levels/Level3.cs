    ...
    public class Level3 : GameScreen
    {
        ...
        public override void LoadContent()
        {
            ...
            tilemapManager = new TilemapManager(map, tileset, tilesetTileWidth, tileWidth, tileHeight,
                GraphicsDevice, Game._spriteBatch);
            #endregion
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (hasWon)
            {
                ...
                // TO DO: case B (game exit)
                if (Button.Put("Wow, you win! Repeat", 30, Color.AliceBlue).Clicked)
                {
                    hasWon = false;
                    Game1.isBlocked = false;

                    // case A
                    Game.currentLevel = Utils.Level.Level1;//.MainMenu;
                    Game.hasLevelChanged = false;
                    Game.gameColor = Color.Pink;//.White;
