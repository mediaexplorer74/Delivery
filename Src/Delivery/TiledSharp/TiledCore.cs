    ...
    public class TmxBase64Data
    {
        ...
        public TmxBase64Data(XElement xData)
        {
            string encoding = (string) (xData.Attribute("encoding")
                ?? xData.Parent?.Attribute("encoding"));

            string compression = (string) (xData.Attribute("compression")
                ?? xData.Parent?.Attribute("compression"));
            if (encoding != "base64")
                throw new Exception(
            ...
            if (compression == "gzip") {
                Data = new System.IO.Compression.GZipStream (
                ...
                Data = new System.IO.Compression.DeflateStream 
                    (bodyStream, System.IO.Compression.CompressionMode.Decompress);
